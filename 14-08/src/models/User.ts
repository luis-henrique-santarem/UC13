...
// Decorators são uma funcionalidade do TypeScript (e do JavaScript moderno) que permitem adicionar comportamento extra a classes, métodos ou propriedades de forma declarativa,
//  usando o símbolo @. É por causa deles que conseguimos 'transformar' as classes e as propriedades dela em tabelas e colunas no nosso banco de dados. Cada decorator, 
// cada @, diz ao ORM o que aquela classe ou propriedade representa.
...
export class User {
    ...
    /*
        ...
        Essa é apenas uma das pontas desta ligação. Devemos declarar o restante na entidade Post, para que o ORM consiga entender completamente
         toda a relação que estamos tentando definir.
    */
