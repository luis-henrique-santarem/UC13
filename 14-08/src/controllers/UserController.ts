...
export class UserController {
    ...
    // O repositório é como uma “camada de acesso ao banco” fornecida pelo TypeORM. É um objeto fornecido pelo TypeORM que sabe como fazer operações no banco
    //  para uma entidade específica. Sem esta linha de código, não conseguimos interagir com o banco.
