...
// Ele habilita o uso de decorators (@Entity, @Column, etc.) para mapear classes em tabelas do banco. Mapear classes em tabelas do banco significa transformar cada classe do código
//  em uma tabela do banco de dados, onde cada propriedade da classe vira uma coluna e cada objeto vira um registro.
...
// Importa as entidades do projeto. Entidades são justamente as classes que representam tabelas do banco de dados dentro do código, descrevendo seus campos (colunas)
//  e relações com outras tabelas.
